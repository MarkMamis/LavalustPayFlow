...
/**
 * SubjectModel
 * Handles subject persistence and related DB operations.
 */
class SubjectModel extends Model
{
    ...
    public function create_subject(array $data)
    {
        ...
        try {
            ...
            error_log('[SubjectModel::create_subject] Exception: ' . $e->getMessage());
            return false;
        }
    }
     ...
     * @return bool
     */
    public function update_subject(int $id, array $data)
    {
        $data['updated_at'] = date('Y-m-d H:i:s');
        try {
            return $this->db->table($this->table)->where('id', $id)->update($data);
        } catch (Exception $e) {
            error_log('[SubjectModel::update_subject] Exception: ' . $e->getMessage());
            return false;
        }
    }
     ...
     * @return bool
     */
    public function delete_subject(int $id)
    {
        try {
            return $this->db->table($this->table)->where('id', $id)->delete();
        } catch (Exception $e) {
            error_log('[SubjectModel::delete_subject] Exception: ' . $e->getMessage());
            return false;
        }
    }
}
